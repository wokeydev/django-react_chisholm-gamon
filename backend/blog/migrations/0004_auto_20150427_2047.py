...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='blogcategory',
            name='parent',
            field=models.ForeignKey(on_delete=models.CASCADE, blank=True, null=True, to='blog.BlogCategory', help_text='Categories, unlike tags, can have a hierarchy. You might have a Jazz category, and under that have children categories for Bebop and Big Band. Totally optional.'),
            preserve_default=True,
        ),
        migrations.AlterField(
            model_name='blogcategoryblogpage',
            name='category',
            field=models.ForeignKey(on_delete=models.CASCADE, verbose_name='Category', related_name='+', to='blog.BlogCategory'),
            preserve_default=True,
        ),
        migrations.AlterField(
            model_name='blogpage',
